...
if CLIENT then
	...
	net.Receive(tag, function()
		...
		if not info.reason then
			...
			chat.AddText(Color(127, 255, 127), bullet, " ", tcol, info.name, Color(127, 127, 127), " (" .. (info.steamid or "BOT") .. ") ", Color(210, 210, 225), "is ", Color(127, 255, 127), "joining", Color(210, 210, 225), " the server!")
		else
