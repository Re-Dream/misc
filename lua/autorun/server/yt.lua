...
YT.Search = function(name, callback)
	http.Fetch("https://www.googleapis.com/youtube/v3/search?part=id&type=video&key=" .. YT.Key .. "&q=" .. encodeURI(name), function(body, len, heads)
